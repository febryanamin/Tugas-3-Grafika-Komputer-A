...
void Demo::BuildTexturedAtas() {
	...
	float vertices[] = {
		...
		// front
		-1.9, 3.5, 3.5, 0, 0, 0.0f,  0.0f,  1.0f, // 0
		1.9,  3.5, 3.5, 1, 0, 0.0f,  0.0f,  1.0f, // 1
		1.9,  3.8, 3.5, 1, 1, 0.0f,  0.0f,  1.0f, // 2
		-1.9, 3.8, 3.5, 0, 1, 0.0f,  0.0f,  1.0f, // 3

		// right
		1.9,  3.5,  3.5,  0, 0, 1.0f,  0.0f,  0.0f, // 4
		1.9,  3.8,  3.5,  1, 0, 1.0f,  0.0f,  0.0f, // 5
		1.9,  3.8,  -3.0, 1, 1, 1.0f,  0.0f,  0.0f, // 6
		1.9,  3.5,  -3.0, 0, 1, 1.0f,  0.0f,  0.0f, // 7

		// back
		-1.9, 3.8, -3.0, 0, 0, 0.0f,  0.0f,  -1.0f, // 8 
		1.9,  3.8, -3.0, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		1.9,  3.5, -3.0, 1, 1, 0.0f,  0.0f,  -1.0f, // 10
		-1.9, 3.5, -3.0, 0, 1, 0.0f,  0.0f,  -1.0f, // 11
		
		// left
		-1.9, 3.5, 3.5,  0, 0, -1.0f,  0.0f,  0.0f, // 12
		-1.9, 3.8, 3.5,  1, 0, -1.0f,  0.0f,  0.0f, // 13
		-1.9, 3.8, -3.0, 1, 1, -1.0f,  0.0f,  0.0f, // 14
		-1.9, 3.5, -3.0, 0, 1, -1.0f,  0.0f,  0.0f, // 15
		
		// upper
		-1.9, 3.8, 3.5,  0, 0, 0.0f,  1.0f,  0.0f, // 16
		1.9,  3.8, 3.5,  1, 0, 0.0f,  1.0f,  0.0f, // 17
		1.9,  3.8, -3.0, 1, 1, 0.0f,  1.0f,  0.0f, // 18
		-1.9, 3.8, -3.0, 0, 1, 0.0f,  1.0f,  0.0f, // 19

		// bottom
		-1.9, 3.5, -3.0, 0, 0, 0.0f,  -1.0f,  0.0f, // 20
		1.9,  3.5, -3.0, 1, 0, 0.0f,  -1.0f,  0.0f, // 21
		1.9,  3.5, 3.5,  1, 1, 0.0f,  -1.0f,  0.0f, // 22
		-1.9, 3.5, 3.5,  0, 1, 0.0f,  -1.0f,  0.0f, // 23
...
void Demo::BuildTexturedKakiKananBelakang() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		1.4, 0.5, 3.4, 0, 0,  0.0f,  0.0f,  1.0f, // 0
		1.7,  0.5, 3.4, 1, 0, 0.0f,  0.0f,  1.0f, // 1
		1.7,  3.6, 3.4, 1, 1, 0.0f,  0.0f,  1.0f, // 2
		1.4, 3.6, 3.4, 0, 1,  0.0f,  0.0f,  1.0f, // 3
		
		// right
		1.7,  0.5,  3.4,  0, 0, 1.0f,  0.0f,  0.0f, // 4
		1.7,  3.6,  3.4,  1, 0, 1.0f,  0.0f,  0.0f, // 5
		1.7,  3.6,  3.1, 1, 1,  1.0f,  0.0f,  0.0f, // 6
		1.7,  0.5,  3.1, 0, 1,  1.0f,  0.0f,  0.0f, // 7
		
		// back
		1.4, 3.6, 3.1, 0, 0,  0.0f,  0.0f,  -1.0f, // 8 
		1.7,  3.6, 3.1, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		1.7,  0.5, 3.1, 1, 1, 0.0f,  0.0f,  -1.0f, // 10
		1.4, 0.5, 3.1, 0, 1,  0.0f,  0.0f,  -1.0f, // 11
		
		// left
		1.4, 0.5, 3.4,  0, 0, -1.0f,  0.0f,  0.0f, // 12
		1.4, 3.6, 3.4,  1, 0, -1.0f,  0.0f,  0.0f, // 13
		1.4, 3.6, 3.1, 1, 1,  -1.0f,  0.0f,  0.0f, // 14
		1.4, 0.5, 3.1, 0, 1,  -1.0f,  0.0f,  0.0f, // 15

		// upper
		1.4, 3.6, 3.4,  0, 0,  0.0f,  1.0f,  0.0f, // 16
		1.7,  3.6, 3.4,  1, 0, 0.0f,  1.0f,  0.0f, // 17
		1.7,  3.6, 3.1, 1, 1,  0.0f,  1.0f,  0.0f, // 18
		1.4, 3.6, 3.1, 0, 1,   0.0f,  1.0f,  0.0f, // 19

		// bottom
		1.4, 0.5, 3.1, 0, 0,   0.0f,  -1.0f,  0.0f, // 20
		1.7,  0.5, 3.1, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
		1.7,  0.5, 3.4,  1, 1, 0.0f,  -1.0f,  0.0f, // 22
		1.4, 0.5, 3.4,  0, 1,  0.0f,  -1.0f,  0.0f, // 23
...
void Demo::BuildTexturedKakiKiriBelakang() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		1.4, 0.5, -2.6, 0, 0,  0.0f,  0.0f,  1.0f, // 0
		1.7,  0.5, -2.6, 1, 0, 0.0f,  0.0f,  1.0f, // 1
		1.7,  3.6, -2.6, 1, 1, 0.0f,  0.0f,  1.0f, // 2
		1.4, 3.6, -2.6, 0, 1,  0.0f,  0.0f,  1.0f, // 3

		// right
		1.7,  0.5,  -2.6,  0, 0, 1.0f,  0.0f,  0.0f, // 4
		1.7,  3.6,  -2.6,  1, 0, 1.0f,  0.0f,  0.0f, // 5
		1.7,  3.6,  -2.9, 1, 1,  1.0f,  0.0f,  0.0f, // 6
		1.7,  0.5,  -2.9, 0, 1,  1.0f,  0.0f,  0.0f, // 7

		// back
		1.4, 3.6, -2.9, 0, 0,  0.0f,  0.0f,  -1.0f, // 8 
		1.7,  3.6, -2.9, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		1.7,  0.5,-2.9, 1, 1,  0.0f,  0.0f,  -1.0f, // 10
		1.4, 0.5, -2.9, 0, 1,  0.0f,  0.0f,  -1.0f, // 11

		// left
		1.4, 0.5, -2.6,  0, 0, -1.0f,  0.0f,  0.0f, // 12
		1.4, 3.6, -2.6,  1, 0, -1.0f,  0.0f,  0.0f, // 13
		1.4, 3.6, -2.9, 1, 1,  -1.0f,  0.0f,  0.0f, // 14
		1.4, 0.5, -2.9, 0, 1,  -1.0f,  0.0f,  0.0f, // 15

		// upper
		1.4, 3.6, -2.6,  0, 0,  0.0f,  1.0f,  0.0f, // 16
		1.7,  3.6, -2.6,  1, 0, 0.0f,  1.0f,  0.0f, // 17
		1.7,  3.6, -2.9, 1, 1,  0.0f,  1.0f,  0.0f, // 18
		1.4, 3.6, -2.9, 0, 1,   0.0f,  1.0f,  0.0f, // 19

		// bottom
		1.4, 0.5, -2.9, 0, 0,  0.0f,  -1.0f,  0.0f, // 20
		1.7,  0.5, -2.9, 1, 0, 0.0f,  -1.0f,  0.0f, // 21
		1.7,  0.5, -2.6, 1, 1, 0.0f,  -1.0f,  0.0f, // 22
		1.4, 0.5, -2.6,  0, 1, 0.0f,  -1.0f,  0.0f, // 23
...
void Demo::BuildTexturedKakiKiriDepan() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-1.8, 0.5, -2.6, 0, 0,  0.0f,  0.0f,  1.0f, // 0
		-1.5,  0.5, -2.6, 1, 0, 0.0f,  0.0f,  1.0f, // 1
		-1.5,  3.6, -2.6, 1, 1, 0.0f,  0.0f,  1.0f, // 2
		-1.8, 3.6, -2.6, 0, 1,  0.0f,  0.0f,  1.0f, // 3

		// right
		-1.5,  0.5,  -2.6,  0, 0, 1.0f,  0.0f,  0.0f, // 4
		-1.5,  3.6,  -2.6,  1, 0, 1.0f,  0.0f,  0.0f, // 5
		-1.5,  3.6,  -2.9, 1, 1,  1.0f,  0.0f,  0.0f, // 6
		-1.5,  0.5,  -2.9, 0, 1,  1.0f,  0.0f,  0.0f, // 7

		// back
		-1.8, 3.6, -2.9, 0, 0,  0.0f,  0.0f,  -1.0f, // 8 
		-1.5,  3.6, -2.9, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		-1.5,  0.5, -2.9, 1, 1, 0.0f,  0.0f,  -1.0f, // 10
		-1.8, 0.5, -2.9, 0, 1,  0.0f,  0.0f,  -1.0f, // 11

		// left
		-1.8, 0.5, -2.6,  0, 0, -1.0f,  0.0f,  0.0f, // 12
		-1.8, 3.6, -2.6,  1, 0, -1.0f,  0.0f,  0.0f, // 13
		-1.8, 3.6, -2.9, 1, 1,  -1.0f,  0.0f,  0.0f, // 14
		-1.8, 0.5, -2.9, 0, 1,  -1.0f,  0.0f,  0.0f, // 15

		// upper
		-1.8, 3.6, -2.6,  0, 0,  0.0f,  1.0f,  0.0f, // 16
		-1.5,  3.6, -2.6,  1, 0, 0.0f,  1.0f,  0.0f, // 17
		-1.5,  3.6, -2.9, 1, 1,  0.0f,  1.0f,  0.0f, // 18
		-1.8, 3.6, -2.9, 0, 1,   0.0f,  1.0f,  0.0f, // 19

		// bottom
		-1.8, 0.5, -2.9, 0, 0,   0.0f,  -1.0f,  0.0f, // 20
		-1.5,  0.5, -2.9, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
		-1.5,  0.5, -2.6,  1, 1, 0.0f,  -1.0f,  0.0f, // 22
		-1.8, 0.5, -2.6,  0, 1,  0.0f,  -1.0f,  0.0f, // 23
...
void Demo::BuildTexturedKakiKananDepan() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-1.8, 0.5, 3.4, 0, 0,  0.0f,  0.0f,  1.0f, // 0
		-1.5,  0.5, 3.4, 1, 0, 0.0f,  0.0f,  1.0f, // 1
		-1.5,  3.6, 3.4, 1, 1, 0.0f,  0.0f,  1.0f, // 2
		-1.8, 3.6, 3.4, 0, 1,  0.0f,  0.0f,  1.0f, // 3

		// right
		-1.5,  0.5,  3.4,  0, 0, 1.0f,  0.0f,  0.0f, // 4
		-1.5,  3.6,  3.4,  1, 0, 1.0f,  0.0f,  0.0f, // 5
		-1.5,  3.6,  3.1, 1, 1,  1.0f,  0.0f,  0.0f, // 6
		-1.5,  0.5,  3.1, 0, 1,  1.0f,  0.0f,  0.0f, // 7

		// back
		-1.8, 3.6, 3.1, 0, 0,  0.0f,  0.0f,  -1.0f, // 8 
		-1.5,  3.6, 3.1, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		-1.5,  0.5, 3.1, 1, 1, 0.0f,  0.0f,  -1.0f, // 10
		-1.8, 0.5, 3.1, 0, 1,  0.0f,  0.0f,  -1.0f, // 11

		// left
		-1.8, 0.5, 3.4,  0, 0, -1.0f,  0.0f,  0.0f, // 12
		-1.8, 3.6, 3.4,  1, 0, -1.0f,  0.0f,  0.0f, // 13
		-1.8, 3.6, 3.1, 1, 1,  -1.0f,  0.0f,  0.0f, // 14
		-1.8, 0.5, 3.1, 0, 1,  -1.0f,  0.0f,  0.0f, // 15

		// upper
		-1.8, 3.6, 3.4,  0, 0,  0.0f,  1.0f,  0.0f, // 16
		-1.5,  3.6, 3.4,  1, 0, 0.0f,  1.0f,  0.0f, // 17
		-1.5,  3.6, 3.1, 1, 1,  0.0f,  1.0f,  0.0f, // 18
		-1.8, 3.6, 3.1, 0, 1,   0.0f,  1.0f,  0.0f, // 19

		// bottom
		-1.8, 0.5, 3.1, 0, 0,   0.0f,  -1.0f,  0.0f, // 20
		-1.5,  0.5, 3.1, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
		-1.5,  0.5, 3.4,  1, 1, 0.0f,  -1.0f,  0.0f, // 22
		-1.8, 0.5, 3.4,  0, 1,  0.0f,  -1.0f,  0.0f, // 23
...
void Demo::BuildTexturedBelakangBawah() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		1.5, 1, 3.1, 0, 0,   0.0f,  0.0f,  1.0f, // 0
		1.7, 1, 3.1, 1, 0,   0.0f,  0.0f,  1.0f, // 1
		1.7, 1.6, 3.1, 1, 1, 0.0f,  0.0f,  1.0f, // 2
		1.5, 1.6, 3.1, 0, 1, 0.0f,  0.0f,  1.0f, // 3

		// right
		1.7,  1,  3.1,  0, 0,   1.0f,  0.0f,  0.0f, // 4
		1.7,  1.6,  3.1,  1, 0, 1.0f,  0.0f,  0.0f, // 5
		1.7,  1.6,  -2.6, 1, 1, 1.0f,  0.0f,  0.0f, // 6
		1.7,  1,  -2.6, 0, 1,   1.0f,  0.0f,  0.0f, // 7

		// back
		1.5, 1.6, -2.8, 0, 0,  0.0f,  0.0f,  -1.0f, // 8 
		1.7,  1.6, -2.8, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		1.7,  1, -2.8, 1, 1,   0.0f,  0.0f,  -1.0f, // 10
		1.5, 1, -2.8, 0, 1,    0.0f,  0.0f,  -1.0f, // 11

		// left
		1.5, 1, 3.1,  0, 0,   -1.0f,  0.0f,  0.0f, // 12
		1.5, 1.6, 3.1,  1, 0, -1.0f,  0.0f,  0.0f, // 13
		1.5, 1.6, -2.8, 1, 1, -1.0f,  0.0f,  0.0f, // 14
		1.5, 1, -2.8, 0, 1,   -1.0f,  0.0f,  0.0f, // 15

		// upper
		1.5, 1.6, 3.1,  0, 0,  0.0f,  1.0f,  0.0f, // 16
		1.7,  1.6, 3.1,  1, 0, 0.0f,  1.0f,  0.0f, // 17
		1.7,  1.6, -2.8, 1, 1, 0.0f,  1.0f,  0.0f, // 18
		1.5, 1.6, -2.8, 0, 1,  0.0f,  1.0f,  0.0f,	 // 19

		// bottom
		1.5, 1, -2.8, 0, 0,  0.0f,  -1.0f,  0.0f, // 20
		1.7,  1, -2.8, 2, 0, 0.0f,  -1.0f,  0.0f, // 21
		1.7,  1, 3.1,  2, 2, 0.0f,  -1.0f,  0.0f, // 22
		1.5, 1, 3.1,  0, 2,  0.0f,  -1.0f,  0.0f, // 23
...
void Demo::BuildTexturedKananBawah() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-1.5, 1, 3.4, 0, 0,   0.0f,  0.0f,  1.0f, // 0
		1.4,  1, 3.4, 1, 0,   0.0f,  0.0f,  1.0f, // 1
		1.4,  1.6, 3.4, 1, 1, 0.0f,  0.0f,  1.0f, // 2
		-1.5, 1.6, 3.4, 0, 1, 0.0f,  0.0f,  1.0f, // 3

		// right
		1.4,  1,  3.4,  0, 0,   1.0f,  0.0f,  0.0f, // 4
		1.4,  1.6,  3.4,  1, 0, 1.0f,  0.0f,  0.0f, // 5
		1.4,  1.6,  3.2, 1, 1,  1.0f,  0.0f,  0.0f, // 6
		1.4,  1,  3.2, 0, 1,    1.0f,  0.0f,  0.0f, // 7

		// back
		-1.5, 1.6, 3.2, 0, 0, 0.0f,  0.0f,  -1.0f, // 8 
		1.4,  1.6, 3.2, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		1.4,  1, 3.2, 1, 1,   0.0f,  0.0f,  -1.0f, // 10
		-1.5, 1, 3.2, 0, 1,   0.0f,  0.0f,  -1.0f, // 11

		// left
		-1.5, 1, 3.4,  0, 0,   -1.0f,  0.0f,  0.0f, // 12
		-1.5, 1.6, 3.4,  1, 0, -1.0f,  0.0f,  0.0f, // 13
		-1.5, 1.6, 3.2, 1, 1,  -1.0f,  0.0f,  0.0f, // 14
		-1.5, 1, 3.2, 0, 1,    -1.0f,  0.0f,  0.0f, // 15

		// upper
		-1.5, 1.6, 3.4,  0, 0,  0.0f,  1.0f,  0.0f, // 16
		1.4,  1.6, 3.4,  1, 0,  0.0f,  1.0f,  0.0f, // 17
		1.4,  1.6, 3.2, 1, 1,   0.0f,  1.0f,  0.0f, // 18
		-1.5, 1.6, 3.2, 0, 1,   0.0f,  1.0f,  0.0f, // 19

		// bottom
		-1.5, 1, 3.2, 0, 0,  0.0f,  -1.0f,  0.0f, // 20
		1.4,  1, 3.2, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
		1.4,  1, 3.4,  1, 1, 0.0f,  -1.0f,  0.0f, // 22
		-1.5, 1, 3.4,  0, 1, 0.0f,  -1.0f,  0.0f, // 23
...
void Demo::BuildTexturedKiriBawah() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-1.5, 1, -2.8, 0, 0,   0.0f,  0.0f,  -1.0f, // 0
		1.4,  1, -2.8, 1, 0,   0.0f,  0.0f,  -1.0f, // 1
		1.4,  1.6, -2.8, 1, 1, 0.0f,  0.0f,  -1.0f, // 2
		-1.5, 1.6, -2.8, 0, 1, 0.0f,  0.0f,  -1.0f, // 3

		// right
		1.4,  1,  -2.8,  0, 0,   1.0f,  0.0f,  0.0f, // 4
		1.4,  1.6,  -2.8,  1, 0, 1.0f,  0.0f,  0.0f, // 5
		1.4,  1.6,  -2.6, 1, 1,  1.0f,  0.0f,  0.0f, // 6
		1.4,  1,  -2.6, 0, 1,    1.0f,  0.0f,  0.0f, // 7

		// back
		-1.5, 1.6, -2.6, 0, 0, 0.0f,  0.0f,  1.0f, // 8 
		1.4,  1.6, -2.6, 1, 0, 0.0f,  0.0f,  1.0f, // 9
		1.4,  1, -2.6, 1, 1,   0.0f,  0.0f,  1.0f, // 10
		-1.5, 1, -2.6, 0, 1,   0.0f,  0.0f,  1.0f, // 11

		// left
		-1.5, 1, -2.6,  0, 0,   -1.0f,  0.0f,  0.0f, // 12
		-1.5, 1.6, -2.6,  1, 0, -1.0f,  0.0f,  0.0f, // 13
		-1.5, 1.6, -2.6, 1, 1,  -1.0f,  0.0f,  0.0f, // 14
		-1.5, 1, -2.6, 0, 1,    -1.0f,  0.0f,  0.0f, // 15

		// upper
		-1.5, 1.6, -2.8,  0, 0, 0.0f,  1.0f,  0.0f, // 16
		1.4,  1.6, -2.8,  1, 0, 0.0f,  1.0f,  0.0f, // 17
		1.4,  1.6, -2.6, 1, 1,  0.0f,  1.0f,  0.0f, // 18
		-1.5, 1.6, -2.6, 0, 1,  0.0f,  1.0f,  0.0f, // 19

		// bottom
		-1.5, 1, -2.6, 0, 0,  0.0f,  -1.0f,  0.0f, // 20
		1.4,  1, -2.6, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
		1.4,  1, -2.8,  1, 1, 0.0f,  -1.0f,  0.0f, // 22
		-1.5, 1, -2.8,  0, 1, 0.0f,  -1.0f,  0.0f, // 23
